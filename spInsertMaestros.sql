...
clinica_id,estado,
remember_token)
VALUES (2,'Doctor','clinica','prueba','$2a$04$cUWYGTCtD/YyM112ykoYbOdqAww65nkftFnABGfp.hh3D5WbSnFuS','gdpm1986@gmail.com',null,null,1,1,null);
select * from rol;
  INSERT INTO proesthetic.usuario_clinica (rol_id,username,nombre,apellido,password,email,created_at,updated_at,
clinica_id,estado,
remember_token)
VALUES (2,'Doctor2','clinica 2','prueba 2','$2a$04$cUWYGTCtD/YyM112ykoYbOdqAww65nkftFnABGfp.hh3D5WbSnFuS','gdpm1986@gmail.com',null,null,1,1,null);
select * from rol;
  INSERT INTO proesthetic.usuario_clinica (rol_id,username,nombre,apellido,password,email,created_at,updated_at,
clinica_id,estado,
remember_token)
VALUES (2,'Doctor3','clinica 3','prueba 3','$2a$04$cUWYGTCtD/YyM112ykoYbOdqAww65nkftFnABGfp.hh3D5WbSnFuS','gdpm1986@gmail.com',null,null,1,1,null);
select * from rol;
